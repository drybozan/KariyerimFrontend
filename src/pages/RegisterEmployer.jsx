...
export default function RegisterEmployer() {
  ...
  const employerRegisterSchema = Yup.object().shape({
    companyName: Yup.string().required("Şirket adı zorunludur").min(2,"Şirket adı 2 karekterden uzun olmalıdır"),
    ...
    password: Yup.string().required("Şifre zorunludur").min(4,"Şifre en az 4 karakter uzunluğunda olmalıdır"),
    ...
    reEmail: Yup.string().required("Email Tekrar zorunludur").oneOf([Yup.ref("email"),null],"Email bilgileri birbiri ile eşleşmiyor"),
  });
  ...
  return (
    <div>
      <Header as="h2" color="green" textAlign="center">
        <Image src="https://i7.uihere.com/icons/809/958/365/register-f2f06ce77022411f9c4773b0bb489834.png" /> İşveren Olarak Kayıt Ol
      </Header>
